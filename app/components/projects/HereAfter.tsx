...
function HereAfter() {
  ...
  const images = [
    { src: Dashboard, alt: "HereAfter Project 1" },
  ...
  return (
    <div className='min-h-screen bg-transparent md:p-8 overflow-auto mt-6 md:mt-10 custom-scrollbar'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 md:gap-16 mb-8'>
          ...
          <div className='max-w-[600px] w-full'>
            <div className='leading-relaxed space-y-6'>
              ...
              >
                ...
                >
                  HereAfter is a map-based social platform that strengthens
                  real-world connections by turning everyday locations into
                  shared memories.
                </span>{" "}
                Think Pokémon Go meets Instagram, but grounded in presence. I
                joined as Fractional Head of Product, leading UX, design
                systems, and strategy to bring the MVP from concept to release.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='lg:col-span-2 px-4 md:px-0'>
          ...
          >
            The heart of the product. Users drop memories and discover
            others&apos; moments, transforming the map into a collective
            landscape.
          </p>
        </div>
        ...
        <div className='lg:col-span-2 px-4 md:px-0'>
          ...
          >
            First impressions matter. Onboarding establishes the visual brand,
            sets emotional tone, builds trust before permission requests, and
            lands users quickly in the core map experience.
          </p>
        </div>
        <div className='lg:col-span-1 flex justify-center'>
          <LightboxVideo
        ...
        <div className='lg:col-span-2 px-4 md:px-0'>
          ...
          >
            In-app (and future push) notifications to support discovery,
        ...
        <div className='lg:col-span-3 px-4 md:px-0'>
          <div className='max-w-[600px] w-full'>
            ...
            >
              Alongside the UX work, I built a compact design system, created
              motion prototypes, pressure-tested the IA, and collaborated with
              engineering to define feasibility, edge cases, and technical
              possibilities.
            </p>
            <p
              className='text-base font-normal'
        ...
        <div className='lg:col-span-3 px-4 md:px-0'>
          <div className='max-w-[600px] w-full'>
            ...
            >
              ...
              aligned around a north star, and built a product foundation to
              support whats next. We now have a framework to test whether
              place-based digital connection can meaningfully reduce isolation
